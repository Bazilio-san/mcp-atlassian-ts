...
NODE_ENV=development pm2 startOrRestart pm2.config.cjs
#NODE_ENV=development pm2 startOrRestart pm2.config.cjs --interpreter=/root/.nvm/versions/node/v18.19.1/bin/node --name $SERVICE
pm2 save
