/**
 * JIRA tool module: jira_batch_get_changelogs
...
/**
 * Tool definition for jira_batch_get_changelogs
 */
...
/**
 * Handler function for jira_batch_get_changelogs
 */
export async function batchGetChangelogsHandler(args: any, context: ToolContext): Promise<any> {
  return withErrorHandling(async () => {
    ...
    logger.info('Executing jira_batch_get_changelogs', args);
