/**
 * JIRA tool module: jira_get_board_issues
...
/**
 * Tool definition for jira_get_board_issues
 */
...
/**
 * Handler function for jira_get_board_issues
 */
export async function getBoardIssuesHandler(args: any, context: ToolContext): Promise<any> {
  return withErrorHandling(async () => {
    ...
    logger.info('Executing jira_get_board_issues', args);
