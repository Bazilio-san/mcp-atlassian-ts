/**
 * JIRA tool module: jira_get_sprint_issues
...
/**
 * Tool definition for jira_get_sprint_issues
 */
...
/**
 * Handler function for jira_get_sprint_issues
 */
export async function getSprintIssuesHandler(args: any, context: ToolContext): Promise<any> {
  return withErrorHandling(async () => {
    ...
    logger.info('Executing jira_get_sprint_issues', args);
