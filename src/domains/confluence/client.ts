...
export class ConfluenceClient {
  ...
  async getContent(
    ...
    return withErrorHandling(async () => {
      ...
      return this.cache.getOrSet(cacheKey, async () => {
        ...
        const response = await this.httpClient.get(`/wiki/rest/api/content/${contentId}`, { params });
  ...
  async getContentBySpaceAndTitle(
    ...
    return withErrorHandling(async () => {
      const cacheKey = generateCacheKey('confluence', 'contentByTitle', { spaceKey, title, ...options });
  ...
  async getSpace(
    ...
    return withErrorHandling(async () => {
      ...
      return this.cache.getOrSet(cacheKey, async () => {
        ...
        const response = await this.httpClient.get(`/wiki/rest/api/space/${spaceKey}`, { params });
  ...
  async getComments(
    ...
    return withErrorHandling(async () => {
      ...
      return this.cache.getOrSet(cacheKey, async () => {
        ...
        const response = await this.httpClient.get(`/wiki/rest/api/content/${contentId}/child/comment`, { params });
        return response.data;
      });
    });
  }
  ...
  async addLabel(contentId: string, label: ConfluenceLabelInput): Promise<ConfluenceLabel> {
    return withErrorHandling(async () => {
      ...
      const response = await this.httpClient.post(`/wiki/rest/api/content/${contentId}/label`, [label]);
  ...
  async getAttachments(
    ...
    return withErrorHandling(async () => {
      ...
      return this.cache.getOrSet(cacheKey, async () => {
        ...
        const response = await this.httpClient.get(`/wiki/rest/api/content/${contentId}/child/attachment`, { params });
        return response.data;
      });
    });
  }
  ...
  async getComments(
    ...
    return withErrorHandling(async () => {
      ...
      return this.cache.getOrSet(cacheKey, async () => {
        ...
        const response = await this.httpClient.get(`/wiki/rest/api/content/${contentId}/child/comment`, {
          params
        });
  ...
  private invalidateContentCache(contentId: string, spaceKey?: string): void {
    ...
    logger.debug('Cache invalidated for content', { contentId, spaceKey, keysCleared: relatedKeys.length });
  }
