# https://github.com/Kacep91/claude-agents/tree/main

# https://github.com/coder/agentapi

Control Claude Code, Goose, Aider, Gemini, Sourcegraph Amp, Codex, Auggie, and Cursor CLI with an HTTP API.

# https://github.com/langley232/claude-code
